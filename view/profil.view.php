  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="annonce">
            ...
            <?php if (empty($annonces)): ?><!-- On regarde si l'utilisateur connecté a des annonces-->
              <h2>Vos annonces</h2>
            ...
            <?php else: ?>
              ...
              <div class="defile_annonce">
                ...
                <div class="defile_annonce_2">
                  <!-- On gère ici les flèches permettant de se deplacer entre les annonces-->
              ...
              <fieldset class="fieldset_annonce">
                <!-- On affiche les informations de l'affiche sélectionnée-->
                ...
                <?php else: ?>
                  ...
                  <div class="une_annonce">
                    ...
                    <!-- Permet de gerer les flèches des photos-->
                    <?php if ($id_photo > 0): ?>
                  ...
                  <!-- permet d'afficher le numéro de la photos actuelle comparé au total de photos-->
